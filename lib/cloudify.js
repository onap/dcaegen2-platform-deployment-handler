...
const getExecutionStatus = function(req, execution_id) {
    ...
    addAuthToOptions(reqOptions, req.query['cfy_tenant_name']);
    logger.debug(req.dcaeReqId, "cloudify.getExecutionStatus(): Calling " + reqOptions.uri + " with Tenant: " + reqOptions.headers.Tenant );
...
const startWorkflowExecution = function(mainReq, deployment_id, workflow_id, parameters) {
    ...
    addAuthToOptions(reqOptions, mainReq.query['cfy_tenant_name']);
    logger.debug(mainReq.dcaeReqId, "cloudify.startWorkflowExecution(): Calling " + reqOptions.uri + " with Tenant: " + reqOptions.headers.Tenant );
...
exports.uploadBlueprint = function(req, bpid, blueprint) {
    ...
    addAuthToOptions(reqOptions, req.query['cfy_tenant_name']);
    logger.debug(req.dcaeReqId, "cloudify.uploadBlueprint(): Calling " + reqOptions.uri + " with Tenant: " + reqOptions.headers.Tenant );
...
exports.createDeployment = function(req, dpid, bpid, inputs) {
    ...
    addAuthToOptions(reqOptions, req.query['cfy_tenant_name']);
    logger.debug(req.dcaeReqId, "cloudify.createDeployment(): Calling " + reqOptions.uri + " with Tenant: " + reqOptions.headers.Tenant );
...
exports.getOutputs = function(req, dpid) {
    ...
    addAuthToOptions(reqOptions, req.query['cfy_tenant_name']);
    logger.debug(req.dcaeReqId, "cloudify.getOutputs(): Calling " + reqOptions.uri + " with Tenant: " + reqOptions.headers.Tenant );
...
exports.getOutputDescriptions = function(req, dpid) {
    ...
    addAuthToOptions(reqOptions, req.query['cfy_tenant_name']);
    logger.debug(req.dcaeReqId, "cloudify.getOutputDescriptions(): Calling " + reqOptions.uri + " with Tenant: " + reqOptions.headers.Tenant );
...
exports.deleteDeployment = function(req, dpid) {
    ...
    addAuthToOptions(reqOptions, req.query['cfy_tenant_name']);
    logger.debug(req.dcaeReqId, "cloudify.deleteDeployment(): Calling " + reqOptions.uri + " with Tenant: " + reqOptions.headers.Tenant );
...
exports.deleteBlueprint = function(req, bpid) {
    ...
    addAuthToOptions(reqOptions, req.query['cfy_tenant_name']);
    logger.debug(req.dcaeReqId, "cloudify.deleteBlueprint(): Calling " + reqOptions.uri + " with Tenant: " + reqOptions.headers.Tenant );
...
function addAuthToOptions(reqOptions, tenantName) {
    var tenantNameToUse;
    ...
    if ( tenantName ) {
        ...
        tenantNameToUse = DEFAULT_TENANT;
    }
    ...
    if (reqOptions.headers) {
        reqOptions.headers.Tenant = tenantNameToUse;
    }
    else {
        reqOptions.headers = {"Tenant" : tenantNameToUse};
    }
...
exports.getNodeInstances = function (mainReq, on_next_node_instances, offset) {
    ...
    addAuthToOptions(reqOptions, mainReq.query['cfy_tenant_name']);
    logger.debug(mainReq.dcaeReqId, "cloudify.getNodeInstances(): Calling " + reqOptions.uri + " with Tenant: " + reqOptions.headers.Tenant );
